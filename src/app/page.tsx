...
export default function Home() {
  return (
    <div className="p-3 md:flex justify-center grid md:grid-cols-2 gap-8 max-screen-w-full" id="content">
    <div className=" flex flex-col justify-center items-start md:items-start">
        <h1 className="text-6xl md:max-w-screen-sm font-bold py-6 px-4 ">Hey, I'm Keith, a seasoned Fullstack Developer.</h1>
